...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=8.5.1`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=8.5.1`
